 ...
 */
package org.openmrs.module.leqela.web.controller;
 ...
 * 'module/leqela/leqelaLink.form'.
 */
@Controller
@RequestMapping(value = "module/leqela/leqelaLink.form")
public class leqelaFormController {
	
	/** Logger for this class and subclasses */
	protected final Log log = LogFactory.getLog(getClass());
	
	/** Success form view name */
	private final String SUCCESS_FORM_VIEW = "/module/leqela/leqelaForm";
